...
type UseSessionStorageProps = (key: string, initialState: string, isRemove?: boolean) => SessionStorage;

export const useSessionStorage: UseSessionStorageProps = (key, initialState, isRemove) => {
