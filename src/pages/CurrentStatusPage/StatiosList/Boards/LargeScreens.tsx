...
const LargeScreens: React.FC<any> = ({
  stationList,
          ...
          >
            <Grid item>
              ...
              >
                ...
                <Grid item style={{ transform: 'translateY(95%)' }}>
                  <S.Font
                    isvertical="true"
            ...
            <Grid item>
              ...
              >
                <div
                  style={{
                    borderTop: `1px solid ${theme.colors.grey_3}`,
                    borderRight: `1px solid ${theme.colors.grey_3}`,
                ...
                >
                  ...
                  <S.Group
                    item
                    style={{ padding: '8px 6px 8px 8px', marginRight: 2 }}
                  >
                    <Grid container direction="column" spacing={2}>
                      <Grid item>
                ...
                >
                  <S.Group
                    item
                    style={{ padding: '8px 8px 8px 7px', marginLeft: 1 }}
                  >
                    <Grid container direction="column" spacing={2}>
                      <Grid item>
                        <Grid container direction="row" spacing={2}>
